...
object Storage {
    ...
    data class ZfsDataset(
        ...
        val aclmode: ZfsGenericProperty? = null,
        val acltype: ZfsGenericProperty? = null,
        val xattr: ZfsGenericProperty? = null,
        val atime: ZfsGenericProperty?= null,
        val casesensitivity: ZfsGenericProperty?= null,
        val checksum: ZfsGenericProperty,
        val exec: ZfsGenericProperty?= null,
        ...
        val quota: ZfsGenericProperty?= null,
        val refquota: ZfsGenericProperty?= null,
        val reservation: ZfsGenericProperty?= null,
        val refreservation: ZfsGenericProperty?= null,
        val copies: ZfsGenericProperty?= null,
        val snapdir: ZfsGenericProperty?= null,
        val readonly: ZfsGenericProperty?= null,
        val recordsize: ZfsGenericProperty?= null,
        val key_format: ZfsGenericProperty?= null,
        val encryption_algorithm: ZfsGenericProperty?= null,
        val used: ZfsGenericProperty?= null,
        val usedbychildren: ZfsGenericProperty?= null,
        val usedbydataset: ZfsGenericProperty?= null,
        val usedbyrefreservation: ZfsGenericProperty?= null,
        val usedbysnapshots: ZfsGenericProperty?= null,
        val available: ZfsGenericProperty?= null,
        val special_small_block_size: ZfsGenericProperty?= null,
        val pbkdf2iters: ZfsGenericProperty?= null,
        val creation: ZfsCreationProperty?= null,
        val snapdev: ZfsGenericProperty?= null,
    ...
    data class DatasetCreatePayload(
        ...
        val acltype: AclType?= null,
        val aclmode: AclMode?= null,
    ...
    data class DatasetCreationResponse(
        ...
        val encrypted: Boolean,
        val mountpoint: String?= null,
        val aclmode: ZfsProperty?= null,
        val acltype: ZfsProperty?= null,
